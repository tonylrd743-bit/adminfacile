    ...
    <section className="overflow-hidden rounded-3xl border border-slate-200 bg-white p-4 shadow-sm sm:p-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl leading-7 text-slate-600">
          Copiez le message ou ouvrez-le dans votre application mail avant de l'envoyer.
        </p>
      </div>
...
function buildEmail(result: AiResult, formData: RequestFormData) {
  ...
  const subject = `Demande administrative – ${procedureLabel}`;
...
Veuillez trouver ci-dessous ma demande concernant ${procedureLabel}.
