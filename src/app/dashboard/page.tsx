import { Clock3, FilePlus2, Files, FolderLock, UserRound } from "lucide-react";
    ...
    <div className="space-y-8">
      ...
      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <DashboardCard
          href="/dashboard/new"
          icon={FilePlus2}
          text="15 démarches françaises avec génération IA spécialisée."
        ...
        <DashboardCard
          href="/dashboard"
          icon={Files}
          text={`${requests?.length ?? 0} dossier(s) enregistré(s) dans votre espace.`}
          title="Mes dossiers"
        />
        <DashboardCard
          href="/dashboard/documents"
          icon={FolderLock}
          text="Ajoutez et téléchargez vos justificatifs."
          title="Mes documents"
        />
        <DashboardCard href="/dashboard/account" icon={UserRound} text="Consultez vos informations utilisateur." title="Mon compte" />
      </section>
